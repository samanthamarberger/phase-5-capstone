...
Client.create(username: 'client1', name: 'Ashley', password_digest: 'password1', email: "ashley@gmail.com", birthday: "11/08/2000", image: 'https://st3.depositphotos.com/1007566/13175/v/450/depositphotos_131750410-stock-illustration-woman-female-avatar-character.jpg', goals: 'Get faster')
Client.create(username: 'client2', name: 'Eli', password_digest: 'password2', email: "eli@gmail.com", birthday: "02/02/1999", image: 'https://www.creativefabrica.com/wp-content/uploads/2023/01/30/Bearded-Man-Avatar-Icon-Graphics-59392089-1.jpg', goals: 'Gain muscle')

# Seed data for Trainers (inherits from User)
Trainer.create(username: 'trainer1', name: 'Mike', password_digest: 'password3', email: "mike@gmail.com", image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPEx2sJPDDumsWYHHFaKSwZGFjEXQU-yTaHw&usqp=CAU', bio: "I ran competitively in college and loved it so much I wanted to teach others.", speciality_id: 1, location: '5662 Cougar Ln, Kearns, UT 84118')
Trainer.create(username: 'trainer2', name: 'Hannah', password_digest: 'password4', email: "hannah@gmail.com", image: 'https://img.redbull.com/images/c_limit,w_1500,h_1000,f_auto,q_auto/redbullcom/2018/06/08/19c9192c-24d3-40ac-984a-cf0385d9bb65/morghan-king-three-time-champion', bio: "I have been lifting weights for 10 years now and I love it.", speciality_id: 2, location: '710 S Utah Valley Dr, American Fork, UT 84003')
